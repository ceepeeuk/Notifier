...
public class EbayParser {
    ...
    private Listing parseListing(JSONObject jsonObj) throws JSONException {
        ...
        */
        ...
        /* get items at the root of the object id, title, and URL are required  image and location are optional */
        ...
        try {
            ...
            try {
                ...
                if (listingType.toLowerCase().contains(this.resources.getString(R.string.ebay_value_auction))) {
    ...
    private String formatCurrency(String amount, String currencyCode) {
        ...
        StringBuilder formattedText = new StringBuilder(amount);
