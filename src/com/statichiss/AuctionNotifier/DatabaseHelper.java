...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String SCHEDULE_QUERY_STRING = "create table " + SCHEDULE_TABLE + " (" + SCHEDULE_ID + " integer primary key, " + SCHEDULE_DURATION + " numeric, " + SCHEDULE_DESCRIPTION + " text);";
    ...
    public Cursor getDurations() {
        return getReadableDatabase().query(SCHEDULE_TABLE, new String[]{SCHEDULE_ID, SCHEDULE_DURATION, SCHEDULE_DESCRIPTION}, null, null, null, null, null);
    }
